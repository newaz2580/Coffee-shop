...
// const uri = "mongodb+srv://<db_username>:<db_password>@cluster0.yzyltda.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0";
...
async function run() {
  try {
    ...
    const coffeeCollection=client.db('coffeeShopDb').collection('shop')
